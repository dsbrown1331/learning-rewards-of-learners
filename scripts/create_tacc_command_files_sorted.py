def create_command_file(envname):
    ...
    command_str += "singularity exec --nv ${SINGULARITY_CACHEDIR}/tacc-maverick-ml-latest.simg python LearnAtariNoviceSnippetsSorted.py --env_name=" + envname +" --seed=0 --reward_model_path=$WORK/output/learned_rewards/" + envname + "_15_sorted_pref.params\n"
    print(command_str)
