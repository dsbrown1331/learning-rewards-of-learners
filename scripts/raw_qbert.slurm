...
# 
#------------------Scheduler Options--------------------
#SBATCH -J LearnRawPreferences_qbert      	# Job name
#SBATCH -N 1                   # Total number of nodes (16 cores/node)
#SBATCH -n 1                  # Total number of tasks
#SBATCH -p gpu          # Queue name
#SBATCH -o /work/05933/dsbrown/maverick/output/logs/LearnRawPreference_qbert.o%j  # Name of stdout output file (%j expands to jobid) 
