...
def create_launch_file(envname):
    ...
    schedule_options = "#SBATCH -J LearnRawPreferences_" + envname +    "      	# Job name\n"
    
    output_name = "#SBATCH -o /work/05933/dsbrown/maverick/output/logs/LearnRawPreference_" + envname + ".o%j  # Name of stdout output file (%j expands to jobid) \n"
    control_file = "export CONTROL_FILE=commands_raw_"+ envname + "\n"
