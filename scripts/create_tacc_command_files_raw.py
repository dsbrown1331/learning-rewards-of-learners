def create_command_file(envname):
    ...
    command_str += "singularity exec --nv ${SINGULARITY_CACHEDIR}/tacc-maverick-ml-latest.simg python LearnAtariNoviceSnippets.py --env_name=" + envname +" --seed=0 --reward_model_path=$WORK/output/learned_rewards/" + envname + "_12_raw_pref.params\n"
    print(command_str)
    f = open("commands_raw_" + envname,'w')
    f.write(command_str)
    f.close()
